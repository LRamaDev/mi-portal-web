...
test('V3.3 muestra la sincronización como estado visible de la app', () => {
  ...
  assert.match(config, /appVersion: '3\.3\.0'/);
...
test('V3.3 comparte la formación directamente por WhatsApp', () => {
  const ui = read('tercer-tiempo-beta-v3/js/v3-3-ui.js');
...
test('V3.3 ordena alfabéticamente convocatoria y edición de jugadores', () => {
  const ui = read('tercer-tiempo-beta-v3/js/v3-3-ui.js');
