...
for(const f of ['config.js','banco-v4.js','banco-v5.js','banco-v6.js','banco-v6-10.js','banco-v6-11.js']) if(fs.existsSync(path.join(root,f))) vm.runInContext(fs.readFileSync(path.join(root,f),'utf8'),context,{filename:f});
...
const invalid=es.filter(e=>!counts.has(e.habilidad)||e.tipo==='choice'&&(!Array.isArray(e.opciones)||!e.opciones.includes(e.respuesta)||new Set(e.opciones).size!==e.opciones.length)||!e.pista||!e.explicacion).map(e=>e.id);
