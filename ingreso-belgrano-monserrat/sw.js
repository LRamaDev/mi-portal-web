const CACHE='ingreso-bm-v5-seguridad-banco';
const ASSETS=['./','./index.html','./styles.css','./app.js','./seguridad.js','./simulacros.js','./testeo.js','./banco-v4.js','./banco-v5.js','./config.js','./manifest.webmanifest','./assets/icon.svg','./data/habilidades.json','./data/ejercicios.json'];
