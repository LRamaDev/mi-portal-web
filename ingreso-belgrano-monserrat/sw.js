const CACHE='ingreso-bm-v3-testeo-familiar';
const ASSETS=['./','./index.html','./styles.css','./app.js','./simulacros.js','./testeo.js','./config.js','./manifest.webmanifest','./assets/icon.svg','./data/habilidades.json','./data/ejercicios.json'];
