const CACHE='ingreso-bm-v4-banco';
const ASSETS=['./','./index.html','./styles.css','./app.js','./simulacros.js','./testeo.js','./banco-v4.js','./config.js','./manifest.webmanifest','./assets/icon.svg','./data/habilidades.json','./data/ejercicios.json'];
