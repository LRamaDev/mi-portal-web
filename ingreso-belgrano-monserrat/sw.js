const CACHE='ingreso-bm-v3-simulacros';
const ASSETS=['./','./index.html','./styles.css','./app.js','./simulacros.js','./config.js','./manifest.webmanifest','./assets/icon.svg','./data/habilidades.json','./data/ejercicios.json'];
