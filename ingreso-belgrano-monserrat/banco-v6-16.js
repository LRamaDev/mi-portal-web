(() => {
  ...
  input('V616-M002','matematica','MAT-NAT-OPS',['comun'],4,'En un torneo se ofrecen 36 entradas por fila durante 18 filas. Si 127 entradas quedaron sin usar, ¿cuántas se utilizaron?','521','Multiplicá las filas por las entradas y luego restá las ausencias.','36 × 18 = 648; 648 − 127 = 521.');
  ...
  choice('V616-M009','matematica','MAT-FR-EQ',['comun'],3,'¿Cuál fracción es equivalente a 15/25?',['3/5','5/3','6/11','10/15'],'3/5','Simplificá numerador y denominador por 5.','15/25 = 3/5.');
  ...
  choice('V616-L020','lengua','LEN-DIAC',['comun'],3,'Completá la condición: «___ sabés la respuesta, explicala con tus palabras».',['Si','Sí','Se','Sé'],'Si','Acá introduce una condición, no una afirmación.','La conjunción condicional si se escribe sin tilde.');
