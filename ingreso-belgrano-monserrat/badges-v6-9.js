(function (factory) {
  ...
  const BADGES = [
    ...
    { id: 'en-marcha', icon: '🚀', title: 'En marcha', category: 'Constancia', description: 'Ya completaste varias sesiones de estudio.', target: 3, unit: 'sesiones', metric: s => s.sessions },
    { id: 'constancia', icon: '⭐', title: 'Constancia', category: 'Constancia', description: 'Sostuviste el estudio a lo largo de varias sesiones.', target: 10, unit: 'sesiones', metric: s => s.sessions },
    { id: 'racha', icon: '🔥', title: 'Racha de estudio', category: 'Constancia', description: 'Volviste a estudiar durante varios días seguidos.', target: 3, unit: 'días seguidos', metric: s => s.maxStreak },
    { id: 'mate-activa', icon: '➗', title: 'Exploradora matemática', category: 'Práctica', description: 'Practicaste Matemática con mucha constancia.', target: 25, unit: 'intentos', metric: s => s.mathAttempts },
    { id: 'lengua-activa', icon: '📚', title: 'Exploradora de palabras', category: 'Práctica', description: 'Practicaste Lengua con mucha constancia.', target: 25, unit: 'intentos', metric: s => s.langAttempts },
    { id: 'equilibrio', icon: '⚖️', title: 'Entrenamiento equilibrado', category: 'Práctica', description: 'Sostuviste la práctica tanto en Matemática como en Lengua.', target: 15, unit: 'por materia', metric: s => Math.min(s.mathAttempts, s.langAttempts) },
    { id: 'persistente', icon: '🧗', title: 'Persistente', category: 'Esfuerzo', description: 'Volviste varias veces sobre un mismo tema sin abandonarlo.', target: 8, unit: 'intentos en un tema', metric: s => s.maxSkillAttempts },
    { id: 'temas-firmes', icon: '💪', title: 'Temas firmes', category: 'Aprendizaje', description: 'Lograste sostener un buen desempeño en varias habilidades con evidencias variadas.', target: 3, unit: 'habilidades', metric: s => s.strongSkills },
    ...
    { id: 'ochenta-puntos', icon: '🏅', title: 'Gran simulacro', category: 'Simulacros', description: 'Lograste un resultado muy sólido en un simulacro completo.', target: 80, unit: 'puntos', metric: s => s.bestSimulationScore },
    { id: 'ritmo-20', icon: '🗓️', title: 'Ritmo sostenido', category: 'Constancia', description: 'Construiste un ritmo sostenido de estudio.', target: 20, unit: 'sesiones', metric: s => s.sessions },
    { id: 'racha-5', icon: '🔥', title: 'Racha larga', category: 'Constancia', description: 'Sostuviste una racha larga de días de estudio.', target: 5, unit: 'días seguidos', metric: s => s.maxStreak },
    { id: 'cien-intentos', icon: '💯', title: 'Mucho entrenamiento', category: 'Práctica', description: 'Acumulaste una trayectoria amplia de práctica entre las dos materias.', target: 100, unit: 'intentos', metric: s => s.totalAttempts },
    { id: 'cinco-firmes', icon: '🌟', title: 'Más temas firmes', category: 'Aprendizaje', description: 'Lograste sostener un buen desempeño en un conjunto amplio de habilidades.', target: 5, unit: 'habilidades', metric: s => s.strongSkills },
    { id: 'nivel-ingreso', icon: '🧠', title: 'Subí la dificultad', category: 'Aprendizaje', description: 'Resolviste correctamente ejercicios de nivel Modo ingreso en distintas habilidades.', target: 2, unit: 'habilidades', metric: s => s.advancedSkills },
    ...
    { id: 'video-aprendo', icon: '🎬', title: 'Miré para entender', category: 'Recursos', description: 'Exploraste videos de apoyo de distintos temas.', target: 3, unit: 'temas con video', metric: s => s.videoTopics },
    { id: 'video-practico', icon: '▶️', title: 'Del video a la práctica', category: 'Recursos', description: 'Después de mirar videos, volviste a los temas para practicarlos.', target: 3, unit: 'temas practicados', metric: s => s.videoPracticeTopics },
    { id: 'simulacros-4', icon: '📝', title: 'Experiencia de simulacros', category: 'Simulacros', description: 'Ya acumulaste experiencia resolviendo simulacros de ingreso.', target: 4, unit: 'simulacros', metric: s => s.fullSimulations },
    { id: 'noventa-puntos', icon: '🏆', title: 'Simulacro destacado', category: 'Simulacros', description: 'Lograste un resultado destacado en un simulacro completo.', target: 90, unit: 'puntos', metric: s => s.bestSimulationScore }
  ];
